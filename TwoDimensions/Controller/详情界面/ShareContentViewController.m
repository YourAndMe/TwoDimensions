...
@interface ShareContentViewController ()<UITextViewDelegate>
{
    UIScrollView *scr;
    UILabel *labelCount;
    UITextView *textView;
...
{
    //导航条
    DetailNav *detailNav = [[DetailNav alloc] initWithFrame:CGRectMake(0, 20, 320, 44) andLeftImage:@"back_btn_n.png" andLeftImageHeightLight:@"back_btn_h.png" andLeftAction:@selector(leftBtnDown) andRightImage:@[] andRightAction:nil andTarget:self andTitleName:[NSString stringWithFormat:@"分享到%@",self.wbName]];
